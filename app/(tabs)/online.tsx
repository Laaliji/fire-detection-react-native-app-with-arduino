...
import { Text, View, StyleSheet, Dimensions, TouchableOpacity, ActivityIndicator, Modal, Image } from "react-native";
...
export default function Online() {
  ...
  const [webViewUrl, setWebViewUrl] = useState("https://1584-105-74-67-203.ngrok-free.app/stream");
  ...
  const SERVER_URL = "http://192.168.1.158:3001";

  const settingUrlWebView = () => {
    setWebViewUrl('https://1584-105-74-67-203.ngrok-free.app/stream');
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.resultContainer}>
              ...
              >
                <Text style={styles.viewVideoText}>Voir la vidéo analysée</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
